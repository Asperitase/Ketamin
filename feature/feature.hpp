...
namespace feature {
    /**
     * @brief Enum representing different categories of features.
     *
     * Used to categorize features into control-related and visual-related features.
     */
    enum class category_t {
        CONTROL, ///< Control-related features.
    ...
    static constexpr auto get_all_categories() noexcept {
        return std::array{ category_t::CONTROL, category_t::VISUAL };
    }

    /**
     * @brief Converts a feature category to its string representation.
     *
    ...
    protected:
        ...
        std::unique_ptr<c_settings> settings_;      ///< Unique pointer to the feature's settings.
